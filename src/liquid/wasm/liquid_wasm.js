...
/* @ts-self-types="./liquid_wasm.d.ts" */
...
export class WasmSimulation {
     ...
     * @param {number} steps
     * @param {number} dt
     * @param {string} intervention_json
     * @returns {string}
     */
    forecast(steps, dt, intervention_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(intervention_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsimulation_forecast(this.__wbg_ptr, steps, dt, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {number} t
     */
    forkFrom(state_json, t) {
        const ptr0 = passStringToWasm0(state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsimulation_forkFrom(this.__wbg_ptr, ptr0, len0, t);
        if (ret[1]) {
     ...
     * @param {string} model_kind
     * @param {Uint8Array} weights
     * @param {number} seed
     */
    constructor(domain_id, model_kind, weights, seed) {
        const ptr0 = passStringToWasm0(domain_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(model_kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(weights, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wasmsimulation_new(ptr0, len0, ptr1, len1, ptr2, len2, seed);
        if (ret[2]) {
     ...
     * @param {number} alpha
     */
    setResidualAlpha(alpha) {
        wasm.wasmsimulation_setResidualAlpha(this.__wbg_ptr, alpha);
    }
    /**
     ...
     * @returns {string}
     */
    stepWithEvents(event_json, dt) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(event_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmsimulation_stepWithEvents(this.__wbg_ptr, ptr0, len0, dt);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('liquid_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
